...
public class HttpResponse {
    ...
    public void setStatus(HttpStatus httpStatus){ this.httpStatus = httpStatus;}
    public void setHeader(String headerName, String headerValue){headerMap.put(headerName, headerValue);}
    public void renderRawBody(byte[] rawBody){
        try{
            byte[] rawResponseLineAndHeaders = buildResponseLineAndHeadersInRawBytes();
    ...
    private byte[] buildResponseLineAndHeadersInRawBytes() {
        ...
        String responseLineAndHeaders = stringBuilder.toString();
        byte[] rawResponseLineAndHeaders = responseLineAndHeaders.getBytes(StandardCharsets.UTF_8);
